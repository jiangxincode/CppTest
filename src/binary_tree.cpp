...
void binary_tree::preorder(binary_node *sub_tree,
...
void binary_tree::inorder(binary_node *sub_tree,
		void (*visit)(binary_node *node))
{
	if (sub_tree == NULL)
	{
...
void binary_tree::postorder(binary_node *sub_tree,
		void (*visit)(binary_node *node))
{
	if (sub_tree == NULL)
	{
...
void binary_tree::levelorder(binary_node *sub_tree,
		void (*visit)(binary_node *node))
{
...
binary_node* binary_tree::get_parent(binary_node *sub_tree,
		binary_node *current)
{
	binary_node *p;
	...
	else if ((sub_tree->left_child == current)
			|| (sub_tree->right_child == current))
	{
		return sub_tree;
	}
...
int binary_tree::get_size(binary_node *sub_tree)
{
	...
	{
		return 1 + get_size(sub_tree->left_child)
				+ get_size(sub_tree->right_child);
	}
}
...
int binary_tree::get_leaf_size(binary_node *sub_tree)
{
	...
	{
		return get_leaf_size(sub_tree->left_child)
				+ get_leaf_size(sub_tree->right_child);
	}
}
