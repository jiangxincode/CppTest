...
static void userHelpAll();
static void userHelpBro();
static void userHelpMul();

static void broadcastSend();
static void broadcastRec();

static void mulControl();
static void multicastSend();
static void multicastRec();
...
/*主函数*/
int mainclcdc11(int argc, char **argv)
{
    WSADATA wsd;
