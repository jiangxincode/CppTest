...
private:
    ...
    //the remain after last update (because md5 may be computed segment by segment)
...
const int S[4][4] = {{7,12,17,22},{5,9,14,20},{4,11,16,23},{6,10,15,21}};
...
int main2000()
{
    ...
    MD5::char8 str[] = "621224jx";
    m.ComputMd5(str,sizeof(str) - 1);
    m.printMd5();

    //if you want to comput segment by segment,you can do as follow,
    //and init() is suggested the begging,and Finalize() must call in the end:
    MD5 n;
    n.init();
    MD5::uchar8 str1[] = "ABCDEFGHIJKLMN";
    MD5::uchar8 str2[] = "OPQRSTUVWXYZabcdefghijk";
    MD5::uchar8 str3[] = "lmnopqrstuvwxyz";
    n.UpdateMd5(str1,sizeof(str1) - 1);
    n.UpdateMd5(str2,sizeof(str2) - 1);
    n.UpdateMd5(str3,sizeof(str3) - 1);
    n.Finalize();
    n.printMd5();
    return 0;
}
